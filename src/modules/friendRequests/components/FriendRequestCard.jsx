...
const FriendRequestCard = ({ user, cancelFriendRequest, acceptFriendRequest }) => {
        ...
        <Box sx={{ marginBottom: '10px' }} >
            <Card>
                ...
                <Collapse in={expand} timeout="auto" unmountOnExit>
                    ...
                    <CardActions sx={{ display: 'flex', justifyContent: 'space-between', paddingY: '0px' }}>
                        <IconButton onClick={() => {cancelFriendRequest(user)}} >
                            <PersonRemoveIcon />
                        </IconButton>
                        <IconButton onClick={()=>{acceptFriendRequest(user)}}>
                            <PersonAddIcon />
                        </IconButton>
                    </CardActions>
                </Collapse>
